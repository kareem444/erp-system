        ...
        <div className='py-3 mt-5'>
            <div className='border rounded-md p-5 relative'>
                <h5
                    ...
                    style={{ top: '-15px' }}
                >
                    {`${translate(TRANSLATE.ADD)} ${translate(TRANSLATE.PRODUCT)}`}
                </h5>
                <div className='grid grid-cols-12 gap-5'>
                    <div className='col-span-5'>
                        <label className='label'>
                            <span className={'label-text text-base-content '}>{`${translate(TRANSLATE.ITEMS)}`}</span>
                        </label>
                        <input
                            type='text'
                    ...
                    <div className='col-span-5'>
                        <label className='label'>
                            <span className={'label-text text-base-content '}>{`${translate(TRANSLATE.QUANTITY)}`}</span>
                        </label>
                        <input
                            type='number'
                            className={`input input-bordered w-full`}
