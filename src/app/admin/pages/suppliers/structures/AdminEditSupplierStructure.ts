...
export const AdminEditSupplierStructure =
    (): IFormComponentProperties => {
        ...
        const handelOnSubmit = (data: IAdminSupplierInputs) => {
            const handelUpdatedSupplierData: any = {
                ...selectedSupplier,
                ...data
            }
            delete handelUpdatedSupplierData.syncid
            mutate(handelUpdatedSupplierData)
        };
